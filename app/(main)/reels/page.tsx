            ...
            <div className="h-full w-full relative">
              ...
              <div className="absolute top-12 left-0 right-0 px-6 flex justify-between items-center pointer-events-none">
                <div className="bg-black/20 backdrop-blur-xl px-4 py-2 rounded-2xl border border-white/5 pointer-events-auto">
                   <h2 className="text-sm font-black text-white italic tracking-widest uppercase italic">PartySpot <span className="text-pink-500">Reels</span></h2>
                </div>
              </div>
              ...
              <div className="absolute bottom-10 left-0 right-16 p-6 space-y-4">
                {/* Club Identity */}
                <button 
